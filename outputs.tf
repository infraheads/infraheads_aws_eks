...
output "eks_cluster_arn" {
  ...
  value       = module.eks_blueprints.cluster_arn
}
...
#   value       = "aws eks --region ${local.context.aws_region_name} update-kubeconfig --name ${module.eks_blueprints.cluster_id}"
# }

output "eks_cluster_status" {
  description = "Amazon EKS Cluster Status"
  value       = module.eks_blueprints.cluster_status
}
...
output "worker_node_security_group_arn" {
  ...
  value       = try(module.eks_blueprints.node_security_group_arn, "EKS Node groups not enabled")
}

output "worker_node_security_group_id" {
  description = "ID of the worker node shared security group"
  value       = try(module.eks_blueprints.node_security_group_id, "EKS Node groups not enabled")
}
...
output "self_managed_node_groups" {
  ...
  value       = var.create_eks && length(var.self_managed_node_groups) > 0 ? module.eks_blueprints_self_managed_node_groups[*] : []
}

output "self_managed_node_group_iam_role_arns" {
  description = "IAM role arn's of self managed node groups"
  value       = var.create_eks && length(var.self_managed_node_groups) > 0 ? values({ for nodes in sort(keys(var.self_managed_node_groups)) : nodes => join(",", module.eks_blueprints_self_managed_node_groups[nodes].self_managed_nodegroup_iam_role_arns) }) : []
}

output "self_managed_node_group_autoscaling_groups" {
  description = "Autoscaling group names of self managed node groups"
  value       = var.create_eks && length(var.self_managed_node_groups) > 0 ? values({ for nodes in sort(keys(var.self_managed_node_groups)) : nodes => join(",", module.eks_blueprints_self_managed_node_groups[nodes].self_managed_asg_names) }) : []
}

output "self_managed_node_group_iam_instance_profile_id" {
  description = "IAM instance profile id of managed node groups"
  value       = var.create_eks && length(var.self_managed_node_groups) > 0 ? values({ for nodes in sort(keys(var.self_managed_node_groups)) : nodes => join(",", module.eks_blueprints_self_managed_node_groups[nodes].self_managed_nodegroup_iam_instance_profile_id) }) : []
}
...
output "managed_node_groups" {
  ...
  value       = var.create_eks && length(var.managed_node_groups) > 0 ? module.eks_blueprints_managed_node_groups[*] : []
}

output "managed_node_groups_id" {
  description = "EKS Managed node groups id"
  value       = var.create_eks && length(var.managed_node_groups) > 0 ? values({ for nodes in keys(var.managed_node_groups) : nodes => join(",", module.eks_blueprints_managed_node_groups[nodes].managed_nodegroup_id) }) : []
}

output "managed_node_groups_status" {
  description = "EKS Managed node groups status"
  value       = var.create_eks && length(var.managed_node_groups) > 0 ? values({ for nodes in keys(var.managed_node_groups) : nodes => join(",", module.eks_blueprints_managed_node_groups[nodes].managed_nodegroup_status) }) : []
}

output "managed_node_group_arn" {
  description = "Managed node group arn"
  value       = var.create_eks && length(var.managed_node_groups) > 0 ? values({ for nodes in keys(var.managed_node_groups) : nodes => join(",", module.eks_blueprints_managed_node_groups[nodes].managed_nodegroup_arn) }) : []
}

output "managed_node_group_iam_role_names" {
  description = "IAM role names of managed node groups"
  value       = var.create_eks && length(var.managed_node_groups) > 0 ? values({ for nodes in keys(var.managed_node_groups) : nodes => join(",", module.eks_blueprints_managed_node_groups[nodes].managed_nodegroup_iam_role_name) }) : []
}

output "managed_node_group_iam_role_arns" {
  description = "IAM role arn's of managed node groups"
  value       = var.create_eks && length(var.managed_node_groups) > 0 ? values({ for nodes in keys(var.managed_node_groups) : nodes => join(",", module.eks_blueprints_managed_node_groups[nodes].managed_nodegroup_iam_role_arn) }) : []
}

output "managed_node_group_iam_instance_profile_id" {
  description = "IAM instance profile id of managed node groups"
  value       = var.create_eks && length(var.managed_node_groups) > 0 ? values({ for nodes in keys(var.managed_node_groups) : nodes => join(",", module.eks_blueprints_managed_node_groups[nodes].managed_nodegroup_iam_instance_profile_id) }) : []
}

output "managed_node_group_iam_instance_profile_arns" {
  description = "IAM instance profile arn's of managed node groups"
  value       = var.create_eks && length(var.managed_node_groups) > 0 ? values({ for nodes in keys(var.managed_node_groups) : nodes => join(",", module.eks_blueprints_managed_node_groups[nodes].managed_nodegroup_iam_instance_profile_arn) }) : []
}
...
output "fargate_profiles" {
  ...
  value       = module.eks_blueprints_fargate_profiles
}

output "fargate_profiles_iam_role_arns" {
  description = "IAM role arn's for Fargate Profiles"
  value       = var.create_eks && length(var.fargate_profiles) > 0 ? { for nodes in sort(keys(var.fargate_profiles)) : nodes => module.eks_blueprints_fargate_profiles[nodes].eks_fargate_profile_role_name } : null
}
...
output "teams" {
  description = "Outputs from EKS Fargate profiles groups "
  value       = var.create_eks && (length(var.platform_teams) > 0 || length(var.application_teams) > 0) ? module.eks_blueprints_teams[*] : []
}
